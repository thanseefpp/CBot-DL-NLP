...
for (patterns,tag) in Xy:
    bag = bag_of_words(tokenized_sentence=patterns,words=all_words)
    X_train.append(bag)
...
# Save Trained Model as a file
EXPORT_FILE = "model/trained_model.pth"
torch.save(trained_model,EXPORT_FILE)

print("Model Pickling Done")